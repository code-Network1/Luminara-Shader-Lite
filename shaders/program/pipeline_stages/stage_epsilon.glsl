/*============================================
 * Luminara Shader Lite - Pipeline Stage Epsilon
 * Tonemapping & Color Processing Stage
 * Advanced Color Enhancement by VcorA
 *============================================*/
...
/* ==========================================
 * COLOR CORRECTION FUNCTIONS - VcorA
 * ========================================== */
...
void main() {
    ...
    DoHighNoonTonemap(color);
        ...
        if (materialMaskInt == 240) {
            color = vec3(0.0, 1.0, 0.0);  // Green Screen Lime Blocks
        }
    #endif
