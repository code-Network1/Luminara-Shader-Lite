                        ...
                        if (mat < 10016) {
                            if (mat < 10008) {
                                if (mat < 10004) { // No directional shading
                                    ...
                                    // Luminara Shader Lite Enhanced Flowers: FIXED - Better grass exclusion
                            ...
                            if (mat < 10024) {
                                if (mat < 10020) { // Non-waving Foliage
                                    ...
                                    // Luminara Shader Lite Enhanced Flowers: FIXED - Better grass exclusion (Non-waving)
                                    float totalColor = color.r + color.g + color.b;
                                    float colorVariance = max(max(abs(color.r - color.g), abs(color.g - color.b)), abs(color.b - color.r));
                                    ...
                                    // Luminara Shader Lite Enhanced Flowers: FIXED - Better detection and grass exclusion
                                    float totalColor = color.r + color.g + color.b;
                                    float colorVariance = max(max(abs(color.r - color.g), abs(color.g - color.b)), abs(color.b - color.r));
                        ...
                        if (mat < 10080) {
                            if (mat < 10072) {
                                ...
                                if (mat < 10076) { // Fire
                                    ...
                                    emission = 2.35;
                                    #ifdef NETHER
                                        emission *= 0.4; // Luminara Shader Lite: Reduce fire emission in Nether
                                    #endif
                                    ...
                                    emission = 1.5;
                                    #ifdef NETHER
                                        emission *= 0.4; // Luminara Shader Lite: Reduce soul fire emission in Nether
                                    #endif
                        ...
                        if (mat < 10400) {
                            ...
                            if (mat < 10408) {
                                ...
                                if (mat < 10412) { // Basalt+
                                    ...
                                    #ifdef NETHER
                                        emission *= 0.3; // Luminara Shader Lite: Significantly reduce glowstone emission in Nether
                                    #endif
                            ...
                            if (mat < 10504) {
                                if (mat < 10500) { // Torch
                                    ...
                                    if (color.r > 0.95) {
                                        ...
                                        #endif
                                        #ifdef NETHER
                                            emission *= 0.4; // Luminara Shader Lite: Reduce torch emission in Nether
                                        #endif
                                        color.r *= 1.4;
                                        color.b *= 0.5;
                                    } 
                                    ...
                                    if (dotColor > 2.0) {
                                        emission = 3.3;
                                        #ifdef END
                                            // Luminara Shader Lite: Enhanced End Rod - DISABLED
                                            // float magicalPulse = 0.8 + 0.4 * sin(frameTimeCounter * 4.0);
                                            // emission *= magicalPulse * 1.2; // More intense in End
                                            // color.rgb *= vec3(1.1, 0.9, 1.3); // Purple-tinted glow
                                        #endif
                                        emission *= 0.4 + max0(0.6 - 0.006 * lViewPos);
                        ...
                        if (mat < 10560) {
                            if (mat < 10552) {
                                ...
                                if (mat < 10556) { // End Portal Frame:Inactive
                                    ...
                                    if (abs(color.r - color.g - 0.05) < 0.10) {
                                        ...
                                        float maxCoord = max(absCoord.x, absCoord.y);
                                        if (maxCoord < 0.2505) { // End Portal Frame:Eye of Ender - GLOW DISABLED
                                            smoothnessG = 0.5;
                                            smoothnessD = 0.5;
                                            // emission = pow2(min(color.g, 0.25)) * 170.0 * (0.28 - maxCoord); // Disabled
                                        } else {
                                            float minCoord = min(absCoord.x, absCoord.y);
                                            if (CheckForColor(color.rgb, vec3(153, 198, 147))
                                            && minCoord > 0.25) { // End Portal Frame:Emissive Corner Bits - GLOW DISABLED
                                                // emission = 1.4; // Disabled
                                                // color.rgb = vec3(0.45, 1.0, 0.6); // Disabled
                                            }
                                        }
                                    }
                            ...
                            if (mat < 10568) {
                                if (mat < 10564) { // Lantern
                                    ...
                                    #ifdef NETHER
                                        emission *= 0.4; // Luminara Shader Lite: Reduce lantern emission in Nether
                                    #endif
...
// Luminara Shader Lite: Global emission reduction system for Nether
#ifdef NETHER
    if (emission > 0.1) {
